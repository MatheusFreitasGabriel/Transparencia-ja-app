    ...
    Scaffold(
        ...
        Column(
            ...
            Column(
                ...
                Text(
                    text = "Monitore seus políticos e receba alertas de gastos.",
            ...
            Column(
                ...
                Button(
                    onClick = {
                        val resultado = AuthRepository.singUpValidation(nome, email, senha)
...
fun SingUpPreview() {
    TransparenciaJaTheme {
        SingUpScreen(onNavigateBack = {}, onNavigateToLogin = {})
    }
}